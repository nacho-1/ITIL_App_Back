//! The itil-back-db crate contains all code related to database access: entities, migrations, functions for validating and reading and writing data.
...
pub mod entities;
/// Helper functions and types for entities.
